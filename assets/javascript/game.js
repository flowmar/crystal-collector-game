...
$(document).ready(function() {
  ...
  // Grab the element with id goal-number and insert goal
    $( "#goal-number" ).html("<p id=\"x-concentration-text\"> Chemical X Level to Reach: <span id=\"goal-number-text\">" + goalNumber + "</span></p>");
  ...
  // When the berries are clicked, add the value that the berry contains to the playerNumber variable
    $("#berry1").on("click", function(){
      ...
      // If player wins based on last click, display winning messages
        else if (playerNumber === goalNumber) {
            $("#goal-number").html("<p class=\"winner\"> You're Cured!!</p>");
            wins += 1;
    ...
    // On click, add berry value to playerNumber and update display
    ...
    // Otherwise, if the player wins based on last click, display winning messages
        else if (playerNumber === goalNumber) {
            $("#goal-number").html("<p class=\"winner\"> You're Cured!!</p>");
            wins += 1;
            $(".wins").html("<p>Wins : " + wins + "</p>");
