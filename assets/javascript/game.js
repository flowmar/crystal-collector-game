...
$(document)
    .ready(function () {
        ...
        $("#goal-number").html("<p id=\"x-concentration-text\"> Chemical X Level to Reach: <span id=\"goal-numbe" +
                "rr-text\">" + goalNumber + "</span></p>");

        // Grab elements with class 'wins-losses' and display variable wins and variable
        // losses
        $(".wins-losses").html("<div> <div class='wins'> Wins: " + wins + "</div><br> <div class='losses'>Losses:" + losses + "</div>");
        ...
        $("#berry1").on("click", function () {
            ...
            if (playerNumber > goalNumber) {
                ...
                alert("death" // If player wins based on last click, display winning messages
                );
            } else if (playerNumber === goalNumber) {
                $("#goal-number").html("<p class=\"winner\"> You're Cured!!</p>");
                wins += 1;
        ...
        $("#berry2").on("click", function () {
            ...
            if (playerNumber > goalNumber) {
                ...
                losses += 1;
                $(".losses").html("<p>" + losses + "</p>");
                alert("death" // Otherwise, if the player wins based on last click, display winning messages
                );
            } else if (playerNumber === goalNumber) {
                $("#goal-number").html("<p class=\"winner\"> You're Cured!!</p>");
                wins += 1;
...
$('#startButton').on('click', function startGame() {}) s